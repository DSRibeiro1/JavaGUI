...
public class TelaInicial extends JFrame implements ActionListener {
	...
	public void telaCadastro() {
		...
		lTitulo.setText("Cadastro de Funcion�rios");
		...
		tabela.setBounds(68, 150, 310, 200);
		...
		bEditar.setBounds(72, 370, 100, 30);
	...
	public class editar implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                f = repository.findById((int) tabela.getValueAt(tabela.getSelectedRow(), 0));
